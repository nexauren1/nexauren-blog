...
function decoratePublicHtmlResponse(request,response){
  ...
  return response.text().then(html=>{
    ...
    const tags=[
      ...
      ['icon',/<link[^>]+rel=["']icon["']/i,'<link rel="icon" type="image/png" href="/assets/favicon-nexauren.png?v=20260925-1"><link rel="icon" type="image/png" sizes="32x32" href="/assets/favicon-nexauren.png?v=20260925-1">'],
    ...
    if (path.startsWith("/tool/categories/imagem/")) {
